...
function validateGuesses(guess){
  if(isNaN(guess)){
    ...
    console.log("please enter the number more than 1")
  }else if(guess >100){
    console.log("please eneter the number less than 100")
  }else{
...
function checkGuesses(guess){
  if(guess ===randomNumber){
    displayMessage("It's amzing !You guessed Right")
...
project - 6
 ```Javascript 
//Asynchronous and events using the project
